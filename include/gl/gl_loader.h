 ...
 * linked at build time - we just grab whatever is already loaded.
 *
 * Usage:
 ...
 *
 * The macro rewrites to (*idk_fn_glGetIntegerv)(...) which dereferences
 * the function pointer.
 *
 * IMPORTANT: this header must be included AFTER any system GL headers.
 * In practice we just don't include system GL headers at all. */
