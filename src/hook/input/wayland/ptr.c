...
static void wptr_enter(void *d, struct wl_pointer *p, uint32_t serial, struct wl_surface *s, wl_fixed_t sx,
                       wl_fixed_t sy);
static void wptr_leave(void *d, struct wl_pointer *p, uint32_t serial, struct wl_surface *s);
static void wptr_motion(void *d, struct wl_pointer *p, uint32_t time, wl_fixed_t sx, wl_fixed_t sy);
static void wptr_button(void *d, struct wl_pointer *p, uint32_t serial, uint32_t time, uint32_t button, uint32_t state);
static void wptr_axis(void *d, struct wl_pointer *p, uint32_t time, uint32_t axis, wl_fixed_t value);
...
static void wptr_motion(void *d, struct wl_pointer *p, uint32_t time, wl_fixed_t sx, wl_fixed_t sy) {
  ...
  if (g_captured) {
    if (g_cursor_shape_device && g_last_enter_serial)
      my_wp_cursor_shape_device_set_shape(g_cursor_shape_device, g_last_enter_serial, WP_CURSOR_SHAPE_DEFAULT);
...
static void wptr_button(void *d, struct wl_pointer *p, uint32_t serial, uint32_t time, uint32_t button,
                        uint32_t state) {
  struct ptr_state *st = (struct ptr_state *)d;
  g_last_pointer_serial = serial;
